  ...
  return (
    <div className="flex flex-col place-items-center text-center justify-center min-h-screen px-4">
      ...
      <div className="-mt-28 mb-20 grid text-gray-400 text-center">
        <h1 className='mb-7 text-7xl font-bold text-white'>
      ...
      <div className="SIGNUP p-10 border-8 border-gray-400 rounded-3xl w-full max-w-3xl">
  
        <h1 className="text-2xl text-center font-bold text-gray-300 mb-8 ">
          SIGN UP
        </h1>
  
        <div className="place-items-center justify-center text-center mb-6">
  
          <div className="flex place-items-center justify-center text-center  mb-4">
  
            <input
            
              className={` flex-1 mb-10 rounded-full p-6 text-gray-300 border-2 border-gray-400 bg-black font-bold ${emailError && ' border-4 border-red-500'}`}
          ...
          {emailError && <p className="font-bold -mt-10 mb-10 text-gray-400">{emailError}</p>}
      ...
      <div className=' google text-center bg-white place-items-center justify-center border-4 w-full mt-10 rounded-full border-white flex'>
